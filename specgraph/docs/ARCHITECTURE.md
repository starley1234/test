...
Это не чанки текста. Два дерева и типизированные рёбра.
...
| URL | Для кого |
|---|---|
| `/` | Разработчик: граф, дерево, схемы пайплайнов, отладка |
| `/app` | Конструктор: 3 шага, крупные кнопки, скачать Excel/Markdown |
